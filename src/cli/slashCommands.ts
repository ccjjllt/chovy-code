...
export const slashCommands: Record<string, SlashEntry> = {
  ...
  new: { help: "Start new session", handler: (_a, ctx) => ctx.appendSystem("Starting new session..."), category: "session", hidden: () => true, enabled: false },
  sessions: { help: "List sessions", handler: (_a, ctx) => ctx.appendSystem("Sessions list unavailable"), category: "session", hidden: () => true, enabled: false },
  resume: { help: "Resume session", handler: (_a, ctx) => ctx.appendSystem("Resuming session..."), category: "session", hidden: () => true, enabled: false },
  continue: { help: "Continue session", handler: (_a, ctx) => ctx.appendSystem("Continuing session..."), category: "session", hidden: () => true, enabled: false },
  rename: { help: "Rename session", handler: (_a, ctx) => ctx.appendSystem("Renamed session"), category: "session", hidden: () => true, enabled: false },
  compact: { help: "Compact context", handler: (_a, ctx) => ctx.appendSystem("Compacting context..."), category: "session", hidden: () => true, enabled: false },
  summarize: { help: "Summarize session", handler: (_a, ctx) => ctx.appendSystem("Summarizing..."), category: "session", hidden: () => true, enabled: false },
  copy: { help: "Copy last message", handler: (_a, ctx) => ctx.appendSystem("Copied to clipboard (simulated)"), category: "session", hidden: () => true, enabled: false },
  export: { help: "Export session", handler: (_a, ctx) => ctx.appendSystem("Exporting session..."), category: "session", hidden: () => true, enabled: false },
  exit: { help: "Exit", handler: (_a, ctx) => ctx.exit(), category: "session", hidden: () => true, enabled: false },
  q: { help: "Quit", handler: (_a, ctx) => ctx.exit(), category: "session", hidden: () => true, enabled: false },
  rewind: { help: "Rewind session", handler: (_a, ctx) => ctx.appendSystem("Rewinding..."), category: "session", hidden: () => true, enabled: false },
  timeline: { help: "Show timeline", handler: (_a, ctx) => ctx.appendSystem("Timeline unavailable"), category: "session", hidden: () => true, enabled: false },
  branch: { help: "Branch session", handler: (_a, ctx) => ctx.appendSystem("Branching session..."), category: "session", hidden: () => true, enabled: false },
  diff: { help: "Show diff", handler: (_a, ctx) => ctx.appendSystem("Diff unavailable"), category: "session", hidden: () => true, enabled: false },
